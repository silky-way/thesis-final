...
impl Vehicle {
    ...
    pub fn interaction(target: Vehicle, source: Vehicle) -> (f32, f32) {
        let (a, b) = match (target, source) { 
            ...
            (Vehicle::Bike, Vehicle::Obstacle) => (2.0, 5.0),
            ...
            (Vehicle::Ebike, Vehicle::Obstacle) => (2.0, 5.0),
            ...
            (Vehicle::SpeedPedelec, Vehicle::Obstacle) => (3.0, 5.0),
            ...
            (Vehicle::Pedestrian, Vehicle::Obstacle) => (3.0, 5.0),
            (Vehicle::Obstacle, _) => (0.0, 1.0)
        };
        (a * 1.0, b * 1.0)
    }
